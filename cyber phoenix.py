...
def banner():
    ...
    print(w+d+"      ((("+w+b+"@@@@@@@@@@@@@@@@"+w+d+")))    "+w+b+"cyber phoenix - version 1.0")
    print(w+b+"      \@@/"+r+",:::,"+w+b+"\/"+r+",:::,"+w+b+"\@@       "+w+"------------------")
    print(w+b+"     /@@@|"+r+":::::"+w+b+"||"+r+":::::"+w+b+"|@@@\\     "+w+"Author by "+y+"muhammed Bilal")
    print(w+b+"    / @@@\\"+r+"':::'"+w+b+"/\\"+r+"':::'"+w+b+"/@@@ \\    "+w+"cyber phoenix yt")
    print(w+b+"   /  /@@@@@@@//\\\@@@@@@@\  \\   "+w+"Instagram cyber_phoenox_")
    print(w+b+"  (  /  '@@@@@====@@@@@'  \  )  "+w+"coding By BILAL")
    print(w+b+"   \(     /          \     )/")
    print(w+b+"     \   (            )   /")
    print(w+b+"          \          /"+w)
...
def start():
    ...
    os.system("clear")
    banner()
    print(r+"[!]"+w+" cyber phoenix warning Use this tool for education purpose only")
